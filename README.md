...
|Should| Pester unit test filename to have the prefix UT. | See tests folder for examples. |
|Should| Pester unit test filename to include the word 'Tests' before '.ps1' extension. | See tests folder for examples. |
